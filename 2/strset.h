...
// Jeżeli istnieje zbiór o identyfikatorze id, zwraca liczbę jego elementów, a w
// przeciwnym przypadku zwraca 0.
size_t strset_size(unsigned long id);

// Jeżeli istnieje zbiór o identyfikatorze id i element value nie należy do tego
// zbioru, to dodaje element do zbioru, a w przeciwnym przypadku nie robi nic.
...
// Jeżeli istnieje zbiór o identyfikatorze id, usuwa wszystkie jego elementy, a
// w przeciwnym przypadku nie robi nic.
...
// porównujemy naturalnie: pierwsze miejsce, na którym się różnią, decyduje o
// relacji większości. Jeśli jeden ciąg jest prefiksem drugiego, to ten będący
// prefiks jest mniejszy. Funkcja strset_comp(id1, id2) powinna zwrócić
